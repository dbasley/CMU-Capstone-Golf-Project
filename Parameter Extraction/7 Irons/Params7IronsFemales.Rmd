---
title: "Extract Parameters for 7 Iron Females"
output:
  html_document:
    df_print: paged
---

# Load Data and Filter to Only 7 Iron Female Shots
...
df_7iron_lim <- filter(df_st_club, Club == "7 Iron" & Sex == "Female")
```
...
ggplot(df_7iron_lim_height1, aes(x = `Max Height - Side`, y = `Max Height - Height`)) +
  ...
  labs(
    title = "Distribution of Shots at Max Height for a 7 Iron - Females",
...
df_ideal_7iron_female_sharable <- data.frame(
...
# Output kable
kable(df_ideal_7iron_female_sharable, escape = TRUE, caption = "Ideal Parameter Estimates for 7 Iron From Centers of Actual Data (Males)") %>%
