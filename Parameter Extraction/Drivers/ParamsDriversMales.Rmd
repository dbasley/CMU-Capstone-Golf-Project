---
title: "Extract Parameters for Driver Males"
output:
  html_document:
    df_print: paged
---

# Load Data and Filter to Only Driver Male Shots
...
df_driver_lim <- filter(df_st_club, Club == "Driver" & Sex == "Male")
```
...
df_ideal_driver_male_sharable <- data.frame(
...
# Output kable
kable(df_ideal_driver_male_sharable, escape = TRUE, caption = "Ideal Parameter Estimates for Driver From Centers of Actual Data (Males)") %>%
